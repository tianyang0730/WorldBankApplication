...
public class Analysis_Type_4 implements Analysis_Type{
    ...
    public double[][] perform(String country_name, int start_year, int end_year) {
        ...
        HashMap<Integer, Double> Land_Area_data =  r.retrieve_country_data(country_name, World_Bank_Data_Retriever.API_FOREST_AREA_DATA_INDICATOR, start_year, end_year);
		...
		double rest_of_forest_area = 100.0 - average_for_selected_years;
        
        results[0][0] = average_for_selected_years;
		results[0][1] = rest_of_forest_area;
